LOCALES=(af ar as ast be bg bn_BD bn_IN bs ca cs cy da dbg de el en_US eo es et eu fa ff fi fr fy fy_NL ga ga_IE gd gl gu gu_IN he hi_IN hr ht hu id it ja km kn ko ku lij lt mk ml mn ms my nb_NO ne_NP nl or pa pl pt pt_BR pt_PT ro ru si sk sl sq sr sr_Latn sv sv_SE ta te th tr uk ur vi xh zh_CN zh_TW zu)
